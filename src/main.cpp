...
// configuration step. It creates a namespace called `ftxui-treretest`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        ftxui-treretest::cmake::project_name,
        ftxui-treretest::cmake::project_version));// version string, acquired
